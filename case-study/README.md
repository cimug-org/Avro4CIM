...
- [8. Example SAR Profile JSON Payloads](#8-example-sar-profile-json-payloads)
  - [8.1. SecurityAnalysisResult.avsc](#82-securityanalysisresultavsc)
  - [8.2. SecurityAnalysisResult_EXTENDED.avsc](#83-securityanalysisresult_extendedavsc)
  - [8.3. Profile Constraint Rules](#84-profile-constraint-rules)
  - [8.4. Complex Constraint Validation](#85-complex-constraint-validation)
