...
- [5. Apache Avro Schema Limitations -vs- JSON and XSD Schema Specifications](#apache-avro-schema-limitations--vs--json-and-xsd-schema-specifications)
  - [5.1. Validation Capabilities](#validation-capabilities)
  - [5.2. Namespace Support](#namespace-support) 
  - [5.3. Inheritance and Type Extension](#inheritance-and-type-extension) 
  - [5.4. Schema Modularity and Reuse](#schema-modularity-and-reuse)  
  - [5.5. Human Readability and Tooling](#human-readability-and-tooling)  
  - [5.6. Type System Compared to JSON Schema](#type-system-compared-to-json-schema) 
