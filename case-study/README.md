...
This derivation of the CSA 2.4 SAR profile was utilize purely for testing various "extended" features (e.g.Compound types) beyond was is defined in the formal profile definition.
